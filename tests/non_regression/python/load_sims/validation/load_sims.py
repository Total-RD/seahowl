...
for ii in range(12):
    print(f"=====> Starting simulation {ii}.")

    # options
    output_folder = "./output"
    seahowl.set_log_level_global(
        "info"
    )  # log levels: critical, info, debug, warn, trace
    ...
    seahowl.io.add_turbine_to_system_from_json(
        "../../../../../data/IEA15MW/onshore/turbine.json", system_core
    )
    ...
    print(f"Finished simulation {ii}.")
